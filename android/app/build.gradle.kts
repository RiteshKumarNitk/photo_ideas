...
android {
    namespace = "com.riteshkumar.photo_ideas_app"
    ...
    defaultConfig {
        ...
        applicationId = "com.riteshkumar.photo_ideas_app"
    ...
    buildTypes {
        release {
            // Use release signing config only if the keystore file is actually set in properties
